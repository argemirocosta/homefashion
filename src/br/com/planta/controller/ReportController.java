...
public class ReportController implements Serializable{
	...
	private ClienteBean Dados = new ClienteBean();
    ...
    public void gerarRelatorioPlantas(ActionEvent action) throws IOException, ParseException {
		...
		this.Dados = (ClienteBean) linhalistagem.getRowData();
...
//				+ File.separator);
	...
	public ClienteBean getDados() {
		return Dados;
	}

	public void setDados(ClienteBean dados) {
		Dados = dados;
	}
